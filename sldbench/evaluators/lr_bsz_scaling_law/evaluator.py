# -*- coding: utf-8 -*-
"""
Evaluator for Learning Rate & Batch Size Scaling Law Discovery.

Evaluates scaling law functions that model the relationship between
learning rate, batch size, data size, model parameters and training loss.
"""
import argparse
...
DATASET_REVISION = "721b846056f031737ff7fa72572c021324e3ec0e"
    ...
    if LOCAL_DATASET_DIR.exists():
        ...
        try:
            dataset = datasets.load_dataset(
                HUB_REPO_ID, name=TASK_NAME, split=split, revision=DATASET_REVISION
            )
        except Exception as e:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluator for Learning Rate & Batch Size Scaling Law Discovery.")

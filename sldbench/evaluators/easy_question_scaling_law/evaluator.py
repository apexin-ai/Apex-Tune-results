# -*- coding: utf-8 -*-
"""
Evaluator for Easy Question Scaling Law Discovery.

Evaluates scaling law functions that model the relationship between
compute (FLOPs) and LLM performance on easy questions.
"""
import argparse
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluator for Easy Question Scaling Law Discovery.")
